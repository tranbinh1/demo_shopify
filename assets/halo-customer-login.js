class CustomerAuth extends HTMLElement {
	constructor() {
        ...
        if(document.querySelector('[data-open-auth-popup]')){
            document.querySelector('[data-open-auth-popup]').addEventListener(
                'click',
        ...
        if(document.querySelector('[data-open-auth-sidebar]')){
            document.querySelector('[data-open-auth-sidebar]').addEventListener(
                'click',
                this.setOpenSidebar.bind(this)
            );
        }
